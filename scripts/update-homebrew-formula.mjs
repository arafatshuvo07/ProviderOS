...
// The release workflow builds `provideros-<version>.tar.gz` with `git archive`
...
export function releaseUrl(version, repository = REPOSITORY) {
  return `https://github.com/${repository}/releases/download/v${version}/provideros-${version}.tar.gz`;
}
...
export function digestFor(sums, version) {
  const asset = `provideros-${version}.tar.gz`;
