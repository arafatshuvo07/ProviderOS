...
- `io.github.kimi-provideros` with `~/.codex/kimi-router`
...
moves their service definitions into `$CODEX_HOME/provideros/migrations`, and
...
`refs/provideros/rollback`, fast-forwards, and reinstalls. A failed install
