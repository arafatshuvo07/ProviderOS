...
Read repository instructions before acting. In this repository, also read [references/provideros-surfaces.md](references/provideros-surfaces.md) when a change touches routing, providers, clients, installers, credentials, the gateway, model publication, desktop surfaces, or releases.
