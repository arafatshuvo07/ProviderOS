...
enum RouterChineseText {
  static let values: [String: String] = [
    ...
    "Fix ProviderOS installation": "修复 Codex 路由安装",
    "Language": "语言",
    "System": "跟随系统",
    ...
    "Enabling lets other local ProviderOS clients spend this user's ChatGPT subscription. Only continue for clients you trust on this Mac.": "启用后，其他本地 ProviderOS 客户端可以消耗此用户的 ChatGPT 订阅。仅对这台 Mac 上你信任的客户端继续。",
    "Enable sharing": "启用共享",
    ...
    "Show all": "全部显示",
    "Hide all": "全部隐藏",
    "Update and verify ProviderOS": "更新并验证 Codex 路由",
    "Running ProviderOS maintenance": "正在维护 Codex 路由",
